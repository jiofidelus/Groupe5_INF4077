    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('North_West', 'North_West'), ('East', 'East'), ('West', 'West'), ('South', 'South'), ('Littoral', 'Littoral'), ('Extreme_North', 'Extreme_North'), ('North', 'North'), ('Adamaoua', 'Adamaoua'), ('Centre', 'Centre'), ('South_West', 'South_West')], max_length=13)),
